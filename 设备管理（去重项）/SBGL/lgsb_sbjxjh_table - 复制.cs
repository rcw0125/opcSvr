...
namespace SBGL
{
    public class lgsb_sbjxjh_table:DbEntity
    {
        ...
        public static List<lgsb_sbjxjh_table> GetList(string whereSql = "1=1", params object[] args)
        {
            return DbContext.LoadDataByWhere<lgsb_sbjxjh_table>(whereSql, args);
        }
